-- Allow the isolated GitHub report worker to call the staff report RPC.
-- Regular authenticated callers remain protected by the existing staff-role check.
...
grant execute on function public.mother_sangha_form_rows_v3(text, text) to authenticated, service_role;
